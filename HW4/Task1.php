...
$works = [
    [
        ...
        "dateStart" => "август 2012",
        "dateEnd" => "март 2021",
        "description" => "Работал в компании ООО СВ-Медиа. Полностью реализовал все технические задачи. ",
    ],
    [
      "name" => "Руководитель технического отдела",
      "dateStart" => "март 2021",
      "dateEnd" => "по настоящее время",
      "description" => "Работаю в компании ООО РГ ОнЛаб. Реализую все технические задачи.",
  ],
];
        ...
        <div class="w3-white w3-text-grey w3-card-4">
          <div class="w3-display-container">
            ...
            <div class="w3-display-bottomleft w3-container w3-text-black">
              <h2>Бондарь Игорь Викторович</h2>
            </div>
          </div>
